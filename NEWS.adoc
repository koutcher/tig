...
Bug fixes:
 ...
 - Fix blob edit in bare repository.
...
Improvements:
 ...
 - Allow hiding +/- signs in the diff view. (#855, #901)
...
Improvements:
 ...
 - Allow going to stage view without Enter. (#1284)
...
Improvements:
 ...
 - Allow toggling revision filtering. (#1173)
...
Improvements:
 ...
 - Allow generating a compilation database. (#1064)
...
Improvements:
 ...
 - Expose settings holding command line argument lists: `file-args`, `rev-args`,
   ...
   allow changing the filtering arguments dynamically. (GH #306)
...
Improvements:
 ...
 - Allow building on Mac OS 10.7 without the configure script. (GH #25)
 ...
 - Allow overriding Git based encoding to UTF-8 by setting
 ...
 - Allow opening blob related to added content in a diff. (GH #91)
